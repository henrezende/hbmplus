defmodule Services.HbmService do
  alias Repository.HbmRepository

  # Getting all the movies.
  def get_all_movies() do
    movies = HbmRepository.list()
  ...
  def get_one_movie(id) when is_binary(id) do
    ...
    try do
      ...
      # Fetching the movie
      movie = HbmRepository.get(object_id)
  ...
  def update_one_movie(id, data) when is_binary(id) do
    try do
      ...
      # updating the movie.
      {:ok, movie} = HbmRepository.update(object_id, data)
  ...
  def delete_one_movie(id) when is_binary(id) do
    try do
      ...
      # deleting the movie.
      {:ok, movie} = HbmRepository.delete(object_id)
